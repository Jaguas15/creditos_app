...
export default {
  ...
  methods: {
    ...
    cargarCreditosCliente(p_id_clinete) {
    ...
    openModal(row){
      //console.log(row);
      if (row.id_cliente > 0){
        //this.id_cliente_creditos = row.id_cliente;
        this.cargarCreditosCliente(row.id_cliente);        
        //CreditosModal.methods.cargarCreditosCliente();     
      }
    },
