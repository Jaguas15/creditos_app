    ...
    fnGuardarCredito() {
      ...
      credito
        ...
        .then(response => {
          ...
          console.log('id credito', select *
          from iuva_liquidaciones l
         where l.nmro_plca = j.nmro_plca
           and l.lqdcion_vlda = 'S'
           and l.vgncia <= 2019)
   and not exists  (select *
          from pagos p
         where p.idntfccion = j.nmro_plca
           and p.estdo_pgo = 'S'
           and p.vgncia <= 2019)
    ...
    fnGuardarDetalleCredito(id_credito) {
      ...
      credito_det
        .credito_detalle_create(datos_detalle)
        .then(response => {})
        .catch(error => {
          console.log(error.data);
        });
