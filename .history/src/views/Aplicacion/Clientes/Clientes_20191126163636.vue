 ...
 <!-- Barrio  -->
           ...
           <div class="col-6">
               <label for = "identificacion">Identificacion</label>
                 <b-form-select id = "identificacion" v-model="datos_cliente.identificacion" :options="Identificacion"></b-form-select>
             </div>
            ...
            <div class="col-6">
             ...
             <!-- departamento --> 
             div class="col-6">
               <label for = "departamento">Identificacion</label>
                 <b-form-select id = "departamento" v-model="selected" :options="Identificacion"></b-form-select>
             </div>
