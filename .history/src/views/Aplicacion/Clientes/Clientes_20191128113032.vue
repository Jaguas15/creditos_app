      ...
      <form @submit.prevent="validateBeforeSubmit('demo')" data-vv-scope="demo">
        ...
        <div>
          ...
          ></b-form-textarea>
           ...
           <b-button class="mt-3" block  float="rigth" @click="$bvModal.hide('bv-modal-example')">Close Me</b-button>
           <b-button   float = "rigth" class="mt-3" variant="success">Success</b-button>
      </form>
    </div>
