                    ...
                    <Datatable :options="dtOptions1" class="table table-striped my-4 w-100" id="datatable1">
                        <thead>
                            <tr>
                                ...
                                <th>Formato</th>
                                <th>Dirección</th>
                                <th class="sort-numeric">Teléfono</th>
                                <th class="sort-alpha" data-priority="2">Identificación</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr class="gradeX" v-for="(cl, index) in clientes" :key="index">
                                <td>{{ cl.nombres }} {{ cl.apellidos}}</td>
                                <td>{{ cl.n_formato }}</td>
                                <td>{{ cl.direccion }}</td>
                                <td>{{ cl.telefono }}</td>
                                <td>{{ cl.n_identificacion }}</td>
                            </tr>                            
                        </tbody>
                    </Datatable>
                </div>
